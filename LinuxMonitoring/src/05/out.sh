...
top5=$(du -sh /* 2>/dev/null | sort -rh | head -n 5)
...
echo -e "\033[107m TOP 10 files of maximum size arranged in descending order (path, size and type):\033[0m"
echo "$top10_files"
echo -e "\033[107m TOP 10 executable files of the maximum size arranged in descending order (path, size and MD5 hash of file):\033[0m"
